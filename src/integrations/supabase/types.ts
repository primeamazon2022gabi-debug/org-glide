...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      companies: {
        Row: {
          ...
          cnpj: string | null
          created_at: string | null
          credit_restrictions: string | null
    ...
    Functions: {
      calculate_company_potential: {
        Args: { p_company_id: string }
        Returns: string
      }
      create_certificate_renewal_tasks: { Args: never; Returns: number }
      ...
      seed_demo_financial_data: {
        Args: { p_org_id: string; p_user_id: string }
        Returns: Json
      }
      seed_demo_financial_data_auto: { Args: never; Returns: Json }
      seed_financial_services_defaults: {
